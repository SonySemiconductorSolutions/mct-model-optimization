...
- :ref:`get_target_platform_capabilities<ug-get_target_platform_capabilities>`: A function to get a TargetPlatformCapabilities for tpc version and the specified device type.
