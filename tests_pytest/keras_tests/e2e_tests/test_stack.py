...
def test_stack():
    ...
    assert 'keras_activation_quantization_holder_3' in [layer.name for layer in q_model.layers] # activation holder for stack layer
    stack_activation_holder = q_model.get_layer('keras_activation_quantization_holder_3')
